...
# ==================================================
fair_value, upside_pct, entry_zone = estimate_fair_value(stock)
...
def estimate_fair_value(stock, fund):
    """
    Simple PE-based fair value estimation
    Uses EPS × reasonable PE
    """

    try:
        info = yf.Ticker(stock + ".NS").info
